 ...
 */
public class TabStat extends Fragment {
    ...
    public void process(JSONArray url,JSONArray likear) throws JSONException {
        ...
        while (!url.isNull(i))
        {
           ...
           // urlList.add(url.getJSONObject(i).getString("url"));
            //headList.add(url.getJSONObject(i).getString("head"));
            listItems.add(ls);
            i++;
        }
